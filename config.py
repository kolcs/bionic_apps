...
class Physionet:
    ...
    if CONFIG_VER >= 1:
        ...
        TRIGGER_EVENT_ID = {'T{}'.format(i): i + 1 for i in range(5)}
        """
        ...
        """
        DROP_SUBJECTS = [89, 88, 92, 100]  # todo: remove 89?
        ...
        CHANNEL_TRANSFORMATION = [35, 36, 37, 38, 39, 40, 41, 46, 47, 48, 49, 50, 51, 52, 57, 58, 59, 60, 61, 62, 63, 4,
                                  5, 6, 14, 15, 16, 17, 18, 23, 24, 25, 26, 27, 28, 29, 30, 31, 34, 42, 45, 53, 44, 54,
                                  56, 64, 67, 68, 69, 70, 71, 72, 73, 74, 75, 80, 81, 82, 83, 84, 92, 93, 94, 104]
